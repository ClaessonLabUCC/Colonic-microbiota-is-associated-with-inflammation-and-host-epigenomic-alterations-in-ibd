...
write.csv(LinMod466209,"ServerRunModel_100Samples_All_cluster4.csv")

save(LinMod466209,file = "ServerRunModel_100Samples_All_cluster4.RData")
...
write.csv(LinMod466209,"ServerRunModel_100Samples_All_fdr_pval_cluster4.csv")

save(LinMod466209,file = "ServerRunModel_100Samples_All_fdr_pval_cluster4.RData")

sink("ServerRunModel_100Samples_All_SessionInfo_cluster4.txt")
sessionInfo()
dim(LinMod466209)
sink()
...
LinTopHits_4 <- LinMod466209[order(LinMod466209$FDR_pval),]

head(LinMod466209[order(LinMod466209$FDR_pval),],814)

LinTopHits_4_sig <- LinTopHits_4[1:813,]
query_cpgs <- LinTopHits_4_sig$CpG
...
LinTopHits_4_sig$Name <- LinTopHits_4_sig$CpG
LinTopHits_4_anno <- merge(LinTopHits_4_sig, anno, by="Name")

save(LinTopHits_4_anno,file = "LinTopHits_4_anno_FDR_BON.RData")
write.csv(LinTopHits_4_anno,file = "LinTopHits_4_anno_FDR_BON.csv")
